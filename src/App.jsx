  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans">
      ...
      <div className={`fixed inset-y-0 left-0 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} md:relative md:translate-x-0 transition duration-200 ease-in-out z-30 w-72 bg-white border-r border-gray-100 flex flex-col shadow-xl md:shadow-none`}>
        ...
        <div className="p-4"><a href={LINK_DESCARGA} target="_blank" rel="noreferrer" className="flex items-center w-full px-4 py-3 mt-4 text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl hover:shadow-lg transform hover:-translate-y-0.5 transition-all"><Icons.Windows /> <span className="ml-2">Descargar App PC</span></a></div>
      </div>
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden bg-gray-50">
        ...
        <main className="flex-1 overflow-y-auto p-8 relative scroll-smooth">
          ...
          {activeTab === "tutoriales" && (
             <div className="w-full h-full absolute inset-0 p-8 pt-0 overflow-hidden"><iframe src={URL_TUTORIALES} className="w-full h-full rounded-3xl border border-gray-200 shadow-xl bg-white" title="Tutoriales" frameBorder="0"></iframe></div>
          )}
        </main>
      </div>
    </div>
